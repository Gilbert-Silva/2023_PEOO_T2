...
class Agenda:
  ...
  def to_json(self):
    return {
      '_Agenda__id': self.__id,
      '_Agenda__data': self.__data.strftime('%d/%m/%Y %H:%M'),
      '_Agenda__confirmado': self.__confirmado,
      '_Agenda__id_cliente': self.__id_cliente,
      '_Agenda__id_servico': self.__id_servico
    }
